...
def add_course(request, id):
    ...
    student= D1051831_course(code= add[id- 1].code, name= add[id- 1].name, classs= add[id- 1].classs, required_elective= add[id- 1].required_elective, credit= add[id- 1].credit, time= add[id- 1].time)
    student.save()
